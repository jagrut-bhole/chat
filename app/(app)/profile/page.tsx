                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                            ...
                            <div className="p-4 rounded-xl bg-black border border-zinc-800 flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-base font-semibold text-zinc-200">{new Date(profileData.createdAt).toLocaleDateString()}</p>
                                </div>
                            </div>
                            ...
                            <div className="p-4 rounded-xl bg-black border border-zinc-800 flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-xs text-zinc-500 font-bold uppercase tracking-wider">Groups Created</p>
                                    <p className="text-base font-semibold text-zinc-200">{profileData.groups.length} Groups</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="bg-black p-5 rounded-xl border border-zinc-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                    <div>
                                        ...
                                        <p className="text-xs text-zinc-500 font-mono">
                                            {profileData.lastLocation || (profileData.latitude ? `${profileData.latitude.toFixed(4)}, ${profileData.longitude?.toFixed(4)}` : "Not set")}
                                        </p>
                                    </div>
                                    <button
