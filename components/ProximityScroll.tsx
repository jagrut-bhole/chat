    ...
    <div ref={containerRef} className="relative h-[400vh] w-full bg-[#050505]">
      ...
      <div className="sticky top-0 h-screen w-full pointer-events-none flex flex-col justify-center items-center z-40 -mt-[100vh]">
        ...
        <motion.div
          ...
          className="absolute left-10 md:left-24 top-1/2 -translate-y-1/2 max-w-md"
        >
        ...
        <motion.div
          ...
          className="absolute right-10 md:right-24 top-1/2 -translate-y-1/2 max-w-md text-right"
        >
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-semibold text-white/80 mb-2">Real proximity.</h2>
        </motion.div>
